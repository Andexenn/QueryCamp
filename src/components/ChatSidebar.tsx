    ...
    <aside style={{
      ...
      {onNavigate && (
        <div style={{ padding: '0 20px 16px' }}>
          <button 
            className="w-full flex items-center gap-2 text-sm justify-center" 
            onClick={onNavigate} 
            style={{ 
              padding: '10px 16px', 
              borderRadius: '8px', 
      ...
      <div style={{ padding: '0 20px 24px' }}>
        <button className="btn-primary w-full flex items-center justify-center gap-2" onClick={createNewSession} style={{ padding: '12px 16px', borderRadius: '8px' }}>
